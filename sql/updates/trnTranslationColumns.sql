...
CREATE TABLE `trnTranslationColumns` (
  ...
  `tableName` varchar(256) CHARACTER SET utf8 NOT NULL,
  `columnName` varchar(128) CHARACTER SET utf8 NOT NULL,
  `masterID` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`tcID`)
