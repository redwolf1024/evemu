...
CREATE TABLE `translationTables` (
  `sourceTable` varchar(200) CHARACTER SET utf8 NOT NULL,
  `destinationTable` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `translatedKey` varchar(200) CHARACTER SET utf8 NOT NULL,
